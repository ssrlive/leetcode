...
//
// Follow up: Could you solve it without using any built-in library for handling large integers (such as BigInteger)?
// Could you solve it without converting the inputs to integer directly?
//
