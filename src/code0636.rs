...
// and when a function call ends, its ID is popped off the stack. The function whose ID is at the top of
// the stack is the current function being executed. Each time a function starts or ends, we write a log with the ID,
