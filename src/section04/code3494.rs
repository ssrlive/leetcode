...
// and must pass through all the wizards sequentially to be brewed properly.
...
// synchronized so that each wizard begins working on a potion exactly when it arrives. ​
//
...
// consider the case where the wizards started preparing the 1st potion at time t = 50. At time t = 58,
