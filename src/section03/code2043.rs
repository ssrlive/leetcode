...
impl Bank {
    ...
    fn transfer(&mut self, account1: i32, account2: i32, money: i64) -> bool {
        if self.balance.len() < account1 as usize || self.balance.len() < account2 as usize {
            return false;
        }
    ...
    fn deposit(&mut self, account: i32, money: i64) -> bool {
        if self.balance.len() < account as usize {
            return false;
        }
    ...
    fn withdraw(&mut self, account: i32, money: i64) -> bool {
        if self.balance.len() < account as usize || self.balance[account as usize - 1] < money {
            return false;
        }
        self.balance[account as usize - 1] -= money;
        true
