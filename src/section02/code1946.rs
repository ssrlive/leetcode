...
fn test() {
    let cases = vec![
        ("132", vec![9, 8, 5, 0, 3, 6, 4, 2, 6, 8], "832"),
        ("021", vec![9, 4, 3, 5, 7, 2, 1, 9, 0, 6], "934"),
        ("5", vec![1, 4, 7, 5, 3, 2, 5, 6, 9, 4], "5"),
    ];
    for (num, change, expect) in cases {
        assert_eq!(Solution::maximum_number(num.to_string(), change), expect);
    }
}
